      ...
      <div className='container mx-auto px-4'>
        <div className='cart'>
          <div className="video-container">
            <video className='cart__video' autoPlay={true} loop muted controls='' preload='auto'>
          ...
          {carts.length === 0 ? (
            ...
            <div className='form__group flex flex-col md:flex-row mt-5 mb-8'>
              <div className="cart-content overflow-x-auto">
                    ...
                    {carts.map((item, index) => (
                      <tr key={index} className='tr'>
                        ...
                        <td className='p-2 text-xl'>
                          <span onClick={() => dispatch(cartActions.removeFromCart(item.id))}><FaTrash /></span>
                        </td>
                      </tr>
                    ))}
                  </tbody>
                ...
                className='product-btn'>Clear All</button>
              </div>
              ...
              <div className='checkout__cart'>
                ...
                <button
                 onClick={handleCheckout}
                   className="place__order w-full"
                 >
                   Check Out
                </button>

                <Link to={'/'}>
                <button className="place__order w-full"><p>Continue Shopping</p></button>
                </Link>
              </div>
            </div>
          )}
